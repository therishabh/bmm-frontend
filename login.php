            ...
            <div class="row">
                <section class="login">
                    <form class="login-form col-md-5 mx-auto">
                        ...
                        <div class="form-group mt-3"><input type="text" placeholder="Enter Email/Phone" class="form-control" maxlength="" name="emailOrPhoneNumber"></div>
                            <div class="form-group"><input type="password" placeholder="Enter Password" class="form-control" maxlength="" name="password"></div>
                            <div class="form-group text-center"><button type="submit" class="btn login-btn">Sign In</button></div>
