...
<body>
    ...
    <section class="book-appointment-banner">
        <img src="assets/images/bridal-makeup-trial.jpg" class="img-fluid">
    </section>
    <section class="online-appointment">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                <h2 class="h2-heading">Book A Bridal Makeup Trial</h2>
                </div>
                <div class="col-md-8">
                    ...
                    <div class="bridal-consultaion-left-box">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <ul><li>Party Makeup</li><li>Engagement Makeup</li><li>Pre Wedding</li><li>Bridal Packages</li></ul>
                            </div>
                        </div>
                    </div>
