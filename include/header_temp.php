    ...
    <nav>
        <div class="container-fluid">
            <ul>
                    ...
                    <div class="submenu">
                        ...
                        <div class="">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <img src="assets/images/brand-nav-img.jpg" alt="" class="img-fluid">
                                </div>
                ...
                <li class="p-relative"><a href="bmm-pro.php">BMM PRO
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="menu-common-list">
                                        <ul>
                                            <li><a href="/salon-login">List your Salon</a></li>
                                            <li><a href="/">List Makeup Artist</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
