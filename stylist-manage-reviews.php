        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="#" class="makeup-artist-opener"><span><i class="fa fa-star icon"></i> Manage Reviews</span> <i class="fa fa-chevron-circle-down icon float-right"></i></a>
                    ...
                    <div class="col-md-9">
                        <div class="manage-user-icon">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="h2-heading">Manage Reviews</h2>
