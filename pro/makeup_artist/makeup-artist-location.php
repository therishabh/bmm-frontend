        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="#" class="makeup-artist-opener"><span><i class="fa fa-map-marker-alt icon"></i> Location</span> <i class="fa fa-chevron-circle-down icon float-right"></i></a>
                ...
                <div class="col-md-9">
                    <div class="manage-user-icon">
                        <div class="col-md-12">
                            <div class="row">
                            <div class="col-md-12">
                                <h2 class="h2-heading">Location</h2>
                            </div>
                            <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input type="text" class="form-control" value="Street No 8">
                                        </div>
                                        </div>
                                        <div class="col-md-6">
                                        <div class="form-group">
